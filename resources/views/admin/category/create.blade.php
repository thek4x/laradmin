                                ...
                                @csrf
                                    ...
                                    <div class="col-6">
                                        <select id="select-beast" placeholder="Üst Kategori..." autocomplete="off" name="category_id">
                                         ...
                                         <div class="col">
                                            <input type="text" class="form-control" placeholder="Kategori Başlık" name='title'/>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Kategori Açıklama" name='description'/>
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Key - Slug Adı" name='slug'/>
                                        </div>
                                    </div>
                                    <div class="row mb-4">       
                                        <div class="col">

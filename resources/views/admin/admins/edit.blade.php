...
@section('content')
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <ul class="nav nav-pills" id="animateLine" role="tablist">
                                                                            ...
                                                                            <li class="nav-item" role="presentation">
                                                                                <button class="nav-link" id="animated-underline-home-tab" data-bs-toggle="tab" href="#form-creator" role="tab" aria-controls="form-creator" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> Form Creator</button>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                ...
                                                @method('PUT')
                                                                    ...
                                                                    <div class="tab-pane fade" id="form-creator" role="tabpanel" aria-labelledby="form-creator-tab">
                                                                        <div class="row">
                                                                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                                                                <form method='POST' action='{{route('form_pages.save')}}'>
                                    @if(count($page_forms)>0)
                                    @csrf
                                                                                    <input type='hidden' name="form_page" value="adminusers" />

                    ...
                    <div class="col-lg-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            @csrf
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Categori, Group Adı, Form Türü " name='category'/>
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Key - Slug Adı - Form Namei" name='key'/>
                                        </div>
                                    </div>
                                    <div class="row mb-4">       
                                        <div class="col">
